...
var EmailContact = exports.EmailContact = function(name, email){
	this.setName(name);
	this.setEmail(email);
};
...
EmailMessagePayload.prototype.setSender = function(emailContact){
	this.data.sender_name = emailContact.getName();
	this.data.sender_email = emailContact.getEmail();
	return this;
};
...
EmailMessagePayload.prototype.setReceiver = function(emailContact){
	this.data.receiver_name = emailContact.getName();
	this.data.receiver_email = emailContact.getEmail();
	return this;
};

EmailMessagePayload.prototype.getBodyObject = function(){
	return this.data.body ? JSON.parse(this.data.body) : null;
};
...
EmailService.prototype.queue = function(queueItem, events){
	this.client.post('email/queue', queueItem.getDataObject(), events);
	return this;
};